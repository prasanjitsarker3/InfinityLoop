...
const ServiceTech = () => {
  return (
    <div className="pb-20 md:px-0 px-8 w-full h-full">
        ...
        {services.map((item, index) => (
          ...
          >
            ...
            >
              ...
              <h1 className="vigaRegular md:text-2xl text-xl font-semibold mt-4 text-center">
                {item.title}
              </h1>
              <p className="mt-2 font-exotwo md:text-lg text-base text-center">
                {item.about}
              </p>
            </motion.div>
          </motion.div>
